...
calObj[0].daysClass["2/26"] = 'Holyday;休業日';
calObj[0].daysClass["2/28"] = 'Holyday;休業日';
calObj[0].daysClass["3/26"] = 'Holyday;休業日';
calObj[0].daysClass["4/16"] = 'Holyday;休業日';
...
//calObj[0].xDays[1] = 'Holyday;定休日'; // 毎月1日にSaleクラスを指定ってことね。
...
//calObj[0].month["2-3"] = 'Holyday;定休日'; // ←この場合は第3火曜日
